...
class VersalPaymentsGateway extends WC_Payment_Gateway {
  ...
  public function admin_options() {
    ...
    wp_add_inline_script('versal-payments-admin', 'window.developServer = "' . esc_url_raw($this->developServer) . '";', 'before');
    wp_add_inline_script('versal-payments-admin', 'window.productionServer = "' . esc_url_raw($this->productionServer) . '";', 'before');
    wp_add_inline_script('versal-payments-admin', 'window.sandboxServer = "' . esc_url_raw($this->sandboxServer) . '";', 'before');
  }
